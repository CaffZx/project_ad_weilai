    ...
    def _upsert_modern_summary(
        ...
        *,
        ...
        INSERT INTO t_advert_agent_modify_suggest_summary (
            ...
            main_push_spend_1d, main_push_spend_3d, main_push_spend_7d,
            broad_auto_spend_1d, broad_auto_spend_3d, broad_auto_spend_7d,
            test_new_spend_1d, test_new_spend_3d, test_new_spend_7d,
            eliminate_bubble_spend_1d, eliminate_bubble_spend_3d, eliminate_bubble_spend_7d,
            main_push_acos_1d, main_push_acos_3d, main_push_acos_7d,
            broad_auto_acos_1d, broad_auto_acos_3d, broad_auto_acos_7d,
            test_new_acos_1d, test_new_acos_3d, test_new_acos_7d,
            eliminate_bubble_acos_1d, eliminate_bubble_acos_3d, eliminate_bubble_acos_7d,
        ...
        ON DUPLICATE KEY UPDATE
            ...
            main_push_spend_1d=VALUES(main_push_spend_1d),
            main_push_spend_3d=VALUES(main_push_spend_3d),
            main_push_spend_7d=VALUES(main_push_spend_7d),
            broad_auto_spend_1d=VALUES(broad_auto_spend_1d),
            broad_auto_spend_3d=VALUES(broad_auto_spend_3d),
            broad_auto_spend_7d=VALUES(broad_auto_spend_7d),
            test_new_spend_1d=VALUES(test_new_spend_1d),
            test_new_spend_3d=VALUES(test_new_spend_3d),
            test_new_spend_7d=VALUES(test_new_spend_7d),
            eliminate_bubble_spend_1d=VALUES(eliminate_bubble_spend_1d),
            eliminate_bubble_spend_3d=VALUES(eliminate_bubble_spend_3d),
            eliminate_bubble_spend_7d=VALUES(eliminate_bubble_spend_7d),
            main_push_acos_1d=VALUES(main_push_acos_1d),
            main_push_acos_3d=VALUES(main_push_acos_3d),
            main_push_acos_7d=VALUES(main_push_acos_7d),
            broad_auto_acos_1d=VALUES(broad_auto_acos_1d),
            broad_auto_acos_3d=VALUES(broad_auto_acos_3d),
            broad_auto_acos_7d=VALUES(broad_auto_acos_7d),
            test_new_acos_1d=VALUES(test_new_acos_1d),
            test_new_acos_3d=VALUES(test_new_acos_3d),
            test_new_acos_7d=VALUES(test_new_acos_7d),
            eliminate_bubble_acos_1d=VALUES(eliminate_bubble_acos_1d),
            eliminate_bubble_acos_3d=VALUES(eliminate_bubble_acos_3d),
            eliminate_bubble_acos_7d=VALUES(eliminate_bubble_acos_7d),
        ...
        cur.execute(
            ...
            (
                ...
                bg.get("main_push_spend_1d"),
                bg.get("main_push_spend_3d"),
                bg.get("main_push_spend_7d"),
                bg.get("broad_auto_spend_1d"),
                bg.get("broad_auto_spend_3d"),
                bg.get("broad_auto_spend_7d"),
                bg.get("test_new_spend_1d"),
                bg.get("test_new_spend_3d"),
                bg.get("test_new_spend_7d"),
                bg.get("eliminate_bubble_spend_1d"),
                bg.get("eliminate_bubble_spend_3d"),
                bg.get("eliminate_bubble_spend_7d"),
                bg.get("main_push_acos_1d"),
                bg.get("main_push_acos_3d"),
                bg.get("main_push_acos_7d"),
                bg.get("broad_auto_acos_1d"),
                bg.get("broad_auto_acos_3d"),
                bg.get("broad_auto_acos_7d"),
                bg.get("test_new_acos_1d"),
                bg.get("test_new_acos_3d"),
                bg.get("test_new_acos_7d"),
                bg.get("eliminate_bubble_acos_1d"),
                bg.get("eliminate_bubble_acos_3d"),
                bg.get("eliminate_bubble_acos_7d"),
                run.overview_text,
                run.create_count,
