...
CREATE TABLE `t_advert_agent_modify_suggest_card` (
  ...
  `campaign_group_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '活动目标分组 ERP 码（由确定性代码产出）',
  `current_portfolio` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '真实 MCP 当前组合：标准组归一化为 ERP 码，未知名称原样保留',
...
CREATE TABLE `t_advert_agent_modify_suggest_summary` (
  ...
  `main_push_current_budget` decimal(10,2) DEFAULT NULL COMMENT '精准主力组当前组合预算(MCP原始值)',
  `broad_auto_current_budget` decimal(10,2) DEFAULT NULL COMMENT '自动广泛组当前组合预算(MCP原始值)',
  `test_new_current_budget` decimal(10,2) DEFAULT NULL COMMENT '精准测试组当前组合预算(MCP原始值)',
  `main_push_spend_1d` decimal(10,2) DEFAULT NULL COMMENT '精准主力组最近1日总实际花费',
  `main_push_spend_3d` decimal(10,2) DEFAULT NULL,
  `main_push_spend_7d` decimal(10,2) DEFAULT NULL,
  `broad_auto_spend_1d` decimal(10,2) DEFAULT NULL COMMENT '自动广泛组最近1日总实际花费',
  `broad_auto_spend_3d` decimal(10,2) DEFAULT NULL,
  `broad_auto_spend_7d` decimal(10,2) DEFAULT NULL,
  `test_new_spend_1d` decimal(10,2) DEFAULT NULL COMMENT '精准测试组最近1日总实际花费',
  `test_new_spend_3d` decimal(10,2) DEFAULT NULL,
  `test_new_spend_7d` decimal(10,2) DEFAULT NULL,
  `eliminate_bubble_spend_1d` decimal(10,2) DEFAULT NULL COMMENT '低价捡漏组最近1日总实际花费',
  `eliminate_bubble_spend_3d` decimal(10,2) DEFAULT NULL,
  `eliminate_bubble_spend_7d` decimal(10,2) DEFAULT NULL,
  `main_push_acos_1d` decimal(6,4) DEFAULT NULL COMMENT '精准主力组ACOS(1d)',
  `main_push_acos_3d` decimal(6,4) DEFAULT NULL,
  `main_push_acos_7d` decimal(6,4) DEFAULT NULL,
  `broad_auto_acos_1d` decimal(6,4) DEFAULT NULL COMMENT '自动广泛组ACOS(1d)',
  `broad_auto_acos_3d` decimal(6,4) DEFAULT NULL,
  `broad_auto_acos_7d` decimal(6,4) DEFAULT NULL,
  `test_new_acos_1d` decimal(6,4) DEFAULT NULL COMMENT '精准测试组ACOS(1d)',
  `test_new_acos_3d` decimal(6,4) DEFAULT NULL,
  `test_new_acos_7d` decimal(6,4) DEFAULT NULL,
  `eliminate_bubble_acos_1d` decimal(6,4) DEFAULT NULL COMMENT '低价捡漏组ACOS(1d)',
  `eliminate_bubble_acos_3d` decimal(6,4) DEFAULT NULL,
  `eliminate_bubble_acos_7d` decimal(6,4) DEFAULT NULL,
